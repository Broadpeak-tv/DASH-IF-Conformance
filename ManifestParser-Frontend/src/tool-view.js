function ToolView() {
  ...
  let modules = MpdParsingService.modules;
  ...
  function render(rootElementId) {
    ...
    let logsElementId = UI.generateElementId();
    ...
    let logsView = UI.createElement({
      id: logsElementId,
      className: "d-grid gap-2 d-md-flex justify-content-md-start align-items-center",
      children: [
        {
          element: "textarea",
    ...
    UI.replaceElement(logsElementId, logsView);
